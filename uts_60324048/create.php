...
// -------------------------------------------------------
// Inisialisasi variabel form & error
// -------------------------------------------------------
$errors   = [];
$kode     = '';
$nama     = '';
...
// -------------------------------------------------------
// Proses form ketika dikirim (POST)
// -------------------------------------------------------
if ($_SERVER['REQUEST_METHOD'] === 'POST') {

    // 1. Ambil dan sanitasi semua input
    ...
    if (empty($errors)) {
        ...
        // Simpan deskripsi null jika kosong
    ...
    <div class="col-lg-7 col-md-9">
      ...
      <div class="card">
        ...
        <div class="card-body p-4">
          ...
          <!-- Ringkasan error jika lebih dari 1 -->
...
<script>
  // Character counter untuk nama_kategori
